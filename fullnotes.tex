...
\begin{tcolorbox}
        ...
        \]
        Observe $L\left[ \frac{\partial y}{\partial r} \Big \vert_{r=0} \right] = 0$ so $\frac{\partial y}{\partial r} \Big \vert_{r=0}$ is a solution to the ODE $L[y]=0$. This is the second solution we were looking for.
        ...
        \[ \frac{\partial y}{\partial r} \Big \vert_{r=0} =  \left[ x^r \ln x \left( \sum_{n=0}^{\infty} a_n(r)x^n \right)+ x^r \sum_{n=1}^{\infty} \frac{\partial a_n(r)}{\partial r}x^{n} \right] \Bigg \vert_{r=0} \]
        Hence
        \[
